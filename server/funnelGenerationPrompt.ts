/**
 * Funnel Generation Prompt Builder v2.6 (includes v2.4 Copy Variation Engine)
...
`);
  ...
  // VARIATION INSTRUCTION (v2.4)
  parts.push(`=== COPY VARIATION SYSTEM ===
For each section, select ONE variation from the provided variation pools (Pool 1-10). Never default to the same option across multiple generations. Mix and match across pools... Analogy B can pair with Step Set C and Testimonial Set D. If the client's intake data provides real testimonials, names, or results, always prioritize that data over the variation pools.
`);
...
`);
  ...
  // EM DASH PROHIBITION (v2.4)
  parts.push(`- NEVER use em dashes (—) anywhere in generated copy. Replace all em dashes with either a period and new sentence, a comma, an ellipsis (...), or a colon. Em dashes look robotic and AI-generated in conversational direct response copy. Scan all output before finalizing and remove any em dash that appears.`);
...
`);
  ...
  // ═══════════════════════════════════════════════════════════════
  // SECTION 30: v2.4 COPY VARIATION ENGINE
  // ═══════════════════════════════════════════════════════════════
  parts.push(`══════════════════ v2.4 COPY VARIATION ENGINE ══════════════════
