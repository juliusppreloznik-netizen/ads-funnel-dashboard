    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-orange-500 to-orange-600 border-0">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={generating}
            className="flex items-center gap-2 px-6 py-3 bg-white text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {generating ? (
              <>
      ...
      {briefs && (
        <div className="grid grid-cols-3 gap-4">
          <Card className="bg-white">
            <div className="text-sm text-gray-500">Sales Calls Analyzed</div>
            <div className="text-2xl font-bold text-gray-900">
              {briefs.source_data.zoom_transcripts_count}
            </div>
          </Card>
          <Card className="bg-white">
            <div className="text-sm text-gray-500">Ad Transcripts Analyzed</div>
            <div className="text-2xl font-bold text-gray-900">
              {briefs.source_data.ad_transcripts_count}
            </div>
          </Card>
          <Card className="bg-white">
            <div className="text-sm text-gray-500">Ads Performance Data</div>
            <div className="text-2xl font-bold text-gray-900">
        ...
        <Card className="bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {briefs.briefs.insights.top_pain_points && (
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2">Top Pain Points</h4>
            ...
            {briefs.briefs.insights.winning_hooks && (
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2">Winning Hook Types</h4>
                <div className="flex flex-wrap gap-2">
            ...
            {briefs.briefs.insights.audience_insights && (
              <div className="md:col-span-2">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Audience Insights</h4>
                <p className="text-gray-600">{briefs.briefs.insights.audience_insights}</p>
              </div>
            )}
          </div>
        </Card>
      ...
      {briefs?.briefs?.briefs && briefs.briefs.briefs.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">Generated Creative Briefs</h3>
      ...
      {!briefs && !error && (
        <Card className="bg-gray-50 border-dashed border-2 border-gray-300">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900">No briefs generated yet</h3>
    ...
    <Card className="bg-white overflow-hidden">
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-900">{brief.title}</h4>
      ...
      {expanded && (
        <div className="mt-4 pt-4 border-t border-gray-100 grid md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">{brief.target_audience}</p>
          </div>
          <div>
            <h5 className="text-sm font-medium text-gray-700">Key Message</h5>
            <p className="text-gray-600 mt-1">{brief.key_message}</p>
          </div>
          <div>
            <h5 className="text-sm font-medium text-gray-700">Pain Point</h5>
            <p className="text-gray-600 mt-1">{brief.pain_point}</p>
          </div>
          <div>
            <h5 className="text-sm font-medium text-gray-700">Proof Element</h5>
            <p className="text-gray-600 mt-1">{brief.proof_element}</p>
          </div>
          <div>
            <h5 className="text-sm font-medium text-gray-700">Call to Action</h5>
            <p className="text-gray-600 mt-1">{brief.call_to_action}</p>
          </div>
          <div>
            <h5 className="text-sm font-medium text-gray-700">Visual Direction</h5>
            <p className="text-gray-600 mt-1">{brief.visual_direction}</p>
          </div>
          {brief.rationale && (
            <div className="md:col-span-2">
              <h5 className="text-sm font-medium text-gray-700">Rationale</h5>
              <p className="text-gray-600 mt-1 bg-gray-50 p-3 rounded-lg">{brief.rationale}</p>
            </div>
          )}
        </div>
      )}
...
function MessageBriefsTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Stats */}
      <div className="grid grid-cols-3 gap-4">
        <Card className="bg-white cursor-pointer hover:ring-2 ring-orange-500" onClick={() => setFilter("all")}>
          <div className="text-sm text-gray-500">Total Briefs</div>
          <div className="text-2xl font-bold text-gray-900">{briefItems.length}</div>
        </Card>
        <Card className="bg-white cursor-pointer hover:ring-2 ring-yellow-500" onClick={() => setFilter("pending")}>
          <div className="text-sm text-gray-500">Pending</div>
          <div className="text-2xl font-bold text-yellow-600">{pendingCount}</div>
        </Card>
        <Card className="bg-white cursor-pointer hover:ring-2 ring-green-500" onClick={() => setFilter("completed")}>
        ...
        {filteredItems.length === 0 ? (
          <Card className="bg-gray-50 border-dashed border-2 border-gray-300">
            <div className="text-center py-8">
              <p className="text-gray-500">No briefs found. Generate some from the AI Strategist tab.</p>
            </div>
          </Card>
        ) : (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">{item.key_message}</p>
                  {item.completed_at && (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <Card className="bg-white">
          ...
          <div className="text-2xl font-bold text-gray-900">{transcripts.length}</div>
        </Card>
        <Card className="bg-white">
      ...
      {/* Calls Table */}
      <Card className="bg-white">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Recent Sales Calls</h3>
        <Table>
          <TableHead>
            <TableRow>
...
function FatigueMonitorTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Ad Fatigue Monitor</h2>
          <p className="text-gray-500">Track creative fatigue based on CPA, CPM, and CTR trends</p>
        </div>
        <button
            ...
            {sortedData.length === 0 ? (
              ...
              sortedData.map((ad) => (
                <TableRow key={ad.ad_id}>
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{ad.days_analyzed} days analyzed</div>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <span className="text-sm text-gray-600">{ad.recommendation}</span>
                  </TableCell>
                </TableRow>
              ))
            )}
...
function PerformanceKPIsTab({ dateRange }: { dateRange: DateRangeValue }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900">Performance KPIs</h2>
        <p className="text-gray-500">Conversion and cost metrics for each ad</p>
      </div>
          ...
          <TableBody>
            {sortedData.map((ad) => (
              <TableRow key={ad.ad_id}>
                ...
                <TableCell className="text-gray-500">{ad.campaign_name}</TableCell>
...
function EngagementKPIsTab({ dateRange }: { dateRange: DateRangeValue }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900">Engagement KPIs</h2>
        <p className="text-gray-500">Video engagement and attention metrics for each ad</p>
      </div>
