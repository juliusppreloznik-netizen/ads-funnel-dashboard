...
export default function IntakeForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-neutral-950 to-black flex items-center justify-center p-6">
      ...
      {/* Main Form Card */}
      <Card className="w-full max-w-2xl bg-white/[0.04] border-white/10 backdrop-blur-xl shadow-2xl">
        <div className="p-12">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              size="lg"
              className="w-full h-14 bg-white hover:bg-white/90 text-black border-0 text-lg font-semibold mt-8"
            >
